...
# oauth Rakefile v7.1.28 - 2026-09-18
...
# rake install                                # Build and install oauth-1.0.0.gem in...
# rake install:local                          # Build and install oauth-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template oauth against itse...
