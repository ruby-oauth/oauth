...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "https://oauth.galtzo.com"
  ...
  spec.metadata["mailing_list_uri"] = "https://www.rubyforum.org/tag/oauth"
  ...
  spec.add_dependency("oauth-tty", "~> 1.0", ">= 1.0.13")               # ruby >= 2.3.0
